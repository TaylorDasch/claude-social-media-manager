...
- `data/performance-ledger.csv` comes from the separate active clean-main worktree. Its rows are measurement observations, not publication receipts. Some content IDs collide across old registry copies; join YouTube records by verified platform/video identity, not a prep ID alone.
