# D.R. HORTON TEMPLE TX — VIDEO PACKAGE (Candidate SHIP — R3 line-hardened)
...
3. **D.R. Horton's 4.99% Offer: The September 30 Close-By Date (Temple TX, 2026)** — The incentive-clock angle no competitor video teaches; points at the offer's own *printed* close-by deadline (which is also DHI's fiscal year-end), so it never ages into a false forecast. Retitle candidate if impressions skew browse.
4. **85 Local Records: The D.R. Horton Temple TX Data Review (2026)** — Leads with the hard local MLS count so the title signals analyst over salesperson, with no cross-source ratio to misread; beats a vague "The Truth About."
5. **Why D.R. Horton Costs Less in Temple: The Tradeoffs (2026)** — Reframes the "why so cheap" search intent as a tradeoff explainer — signals analysis over a knock, and pairs the standardization story with review intent.

Recommended: #1 for search + suggested; #3 as the retitle candidate if impressions skew browse.

---

## 2. COLD OPENS (3 options — no presenter name/logo/credential in the first 15 seconds; the identity line "I'm Taylor Dasch with EG Realty" is written to land ~0:15–0:17. Option A is used in the full script and carries the required evergreen-proofed "As I record this…" open with the BBB "A+ and 1.07 at once" chip inside the first 15 seconds. NOTE: per the ship edit, Option A's spoken hook lands the contradiction plus one scope line ("different platforms, different samples"); the fuller caveat detail — different populations, checked July 2026 — rides in lower-third G14a. The presenter's name is not spoken before 0:15.)

**A — The Review Split (recommended; used in the full script):**
"As I record this, one Temple builder's sales offices hold a 4.9 on Google. The same company sits near one star on its national pages — and the Better Business Bureau's national profile scores it 1.07. Same builder. Both real. Different platforms, different samples — I'll show you exactly what each one does and doesn't prove. *(~0:16)* I'm Taylor Dasch with EG Realty. By the end you'll know where that split comes from, why the current offer carries a September 30th deadline, and the one number in July's closing data most buyers skip right past."
...
*[GRAPHIC G13: "Three Creeks = Bell County MUD #1: +0.783% ≈ $2,349/yr on $300K appraised value, no exemptions applied · verify the parcel's actual taxable value & exemptions · 2025 rate (BellCAD) · one line in the full tax stack"]*

And one tax line most buyers miss. Three Creeks sits in Bell County MUD Number One. BellCAD's 2025 adopted rate added zero-point-seven-eight-three percent — on a $300,000 appraised value with no exemptions applied, about $2,349 a year. Verify the parcel's actual taxable value and exemptions, and pull the complete taxing-entity list — it's one line in the full stack. Same builder, same signs, different tax bill.
...
Three: the month-eleven inspection — independent, before the one-year workmanship coverage runs out; full breakdown in the Stylecraft review. The D.R. Horton detail: their sample warranty runs one-two-ten, administered by RWC, a third party. Programs vary, so confirm coverage, exclusions, and deadlines in the booklet delivered with your home, follow its notice-and-submission procedure, and keep written confirmations, emails, photos, and every deadline.
...
- **Composition:** Left ~60%: clean daytime front elevation of a DRH spec from Taylor's real Pecan Creek shoot, using `/Users/taylordasch_1/Projects/01_Listings_Buyers/pecan-creek-drone-photos-2026-07-26/crops/pecan-creek-model-home-hero-2400x1350.jpg` as the primary background (or a stronger frame from the indexed real B-roll after review), with a slight dusk grade. Do not substitute generated house imagery. Floating over it: green chip "4.9★" top-left, red chip "1.07★" just below, thin fracture line between them. Right ~40%: Taylor chest-up, arms crossed, facing camera.
...
- Title: "D.R. Horton's National BBB Profile: A+ and 1.07 Stars — What Temple Buyers Should Know (2026)"
- Hook line: "On its national profile, the Better Business Bureau gives this builder an A-plus and a 1.07-star review score — at the same time."
- Beat map (≤60s): 0–4s two-number card, "BBB national/corporate profile · A+ rating · not accredited · 1.07★ (~264 reviews) · ~741 complaints/3 yrs · pulled July 2026" → 4–22s the fix: the letter grade weighs complaint history and responsiveness — customer reviews aren't in that formula; the 1.07 is the separate review average → 22–42s so an A-plus rating and a 1.07 review average can appear at once; it doesn't average to a middle → 42–52s "and that's just the national profile — Yelp, ConsumerAffairs, and the local Google sales offices all measure different samples" (show filming date + denominators on screen) → 52–60s "the full cross-platform decode and the five checks are on the channel."
- Note: keep this Short to the BBB national-profile split alone; the six-profile spread lives in the long-form only.
...
- Beat map: 0–4s "−3.7% ≈ $9,250 on $250K" card → 4–20s the pull: CTXMLS 7/13/26, 27 closed, median $254,000 → 20–40s the honest caveat: the stat can't show when the price moved or what incentives rode along — but list has been a start, not a floor → 40–55s "median active/pending $248,900, 1,612 sqft — separate medians" (stamped, CTXMLS, deemed reliable not guaranteed) → 55–60s CTA.
