...
- **The HTML uses a `pk.` public token** — safe to embed. If the token ever gets flagged or you rotate it, update the `mapboxgl.accessToken` line near the top.
...
- **Video #2:** PCS to Fort Hood — Why Smart Military Families Skip Killeen and Live in Temple
