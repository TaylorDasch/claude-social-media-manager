# Council Prompt — Stylecraft Homes Review (Living in Temple)
...
- **Footprint:** 8 active Bell County communities (Temple, Belton, Killeen, Nolanville), **$224,900–$479,900**, 1,262–3,285 SF, 3–6 bed. Entry: South Pointe. Top: The Homestead. 4 ISDs: Belton, Temple, Academy, Killeen.
- **Scale:** ranked #74 nationally; 857 homes / $277M revenue in 2024. Founded 1988, HQ College Station, President Randy French. BBB A+. Eliant scores 2.3–5.0 (volatile).
- **Build:** engineered slabs (Blackland Prairie clay), James Hardie cement-fiberboard siding + stone/brick, granite + smart-home standard. Manual-J HVAC sizing they will NOT let you override.
- **The catches (the honest half):** recurring drainage/grading defects (graded "by eye"), plumbing failures within weeks of closing, LVP flooring lifting; 1-2-10 warranty enforced rigidly with a hard 365-day workmanship cutoff and a warranty dept that requires escalation. MUD overlays (Northgate ~2.96%, Three Creeks ~2.28%) the base price doesn't advertise. Year-2 escrow jump of $150–$350/mo when the county reassesses.
- **The single most important buyer move:** schedule an independent **11-month warranty inspection** ($400–$500) before the Day-365 cutoff.

## Voice / lane rules
- Analyst + active-operator voice. Data first, honest, blunt. Say **agent**, not broker.
- Taylor is NOT prior service — never imply military service; he's a Fort Hood-corridor market analyst.
- **No dollar-volume brag ($27M/$30M) in video** — credential = closings + Bell County ranking.
- Banned: dream home, charming, nestled, vibrant, turnkey, hidden gem, welcome home.
- Honest-review framing protects authority: the financing praise is real, the warranty caution is real, both on camera.
...
8. **Shorts cuts** (1–3): the 11-month-inspection gem; the "every incentive requires Kangaroo" trap; the 3.99%-but-read-this hook. Cross-post TikTok + IG Reels + YT Shorts via Postiz (buyers/relocators lane only).

## Embed spot (page→video flywheel)
Embed the finished YouTube video in the review page **inside the "Current Stylecraft Incentives / financing" section** (below the AI Answer Box, near the rate callout) — the review video reinforces the exact financing claim the page ranks on. Add its `VideoObject` to the existing schema stack (the page already carries one VideoObject for the 1818 home tour; a second is fine). Then set the pinned comment + UTM link.

## Success measure
Two leads from one research effort: the page captures "stylecraft homes review / is stylecraft a good builder" search intent; the video captures YouTube discovery intent from buyers browsing new construction. Watch CTR/position on the page in GSC 10–14 days post-title-change; watch video retention on the financing + warranty beats.
